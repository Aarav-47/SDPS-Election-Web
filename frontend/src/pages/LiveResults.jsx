    ...
    <div className="kiosk-bg min-h-screen relative overflow-hidden">
      ...
      <header className="relative z-10 max-w-7xl mx-auto px-8 pt-10 flex items-center justify-between">
        ...
        <div className="text-right">
          ...
          <div
            className={`mt-2 inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/70 backdrop-blur border border-white/80 ${
              pulse ? "ring-2 ring-[color:var(--sdps-gold)]" : ""
            }`}
          >
            <RefreshCw
              className={`w-3.5 h-3.5 text-[color:var(--sdps-blue)] ${
                pulse ? "animate-spin" : ""
              }`}
            />
